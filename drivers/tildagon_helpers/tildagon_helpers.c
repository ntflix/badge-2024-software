...
static portMUX_TYPE crit_mux = portMUX_INITIALIZER_UNLOCKED;

static mp_obj_t tildagon_enter_critical_section()
{
    taskENTER_CRITICAL(&crit_mux);
    return mp_const_none;
}
static MP_DEFINE_CONST_FUN_OBJ_0(tildagon_enter_critical_section_obj, tildagon_enter_critical_section);

static mp_obj_t tildagon_leave_critical_section()
{
    taskEXIT_CRITICAL(&crit_mux);
    return mp_const_none;
}
static MP_DEFINE_CONST_FUN_OBJ_0(tildagon_leave_critical_section_obj, tildagon_leave_critical_section);
...
static const mp_rom_map_elem_t tildagon_helpers_module_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_enter_critical_section), MP_ROM_PTR(&tildagon_enter_critical_section_obj)},
    {MP_ROM_QSTR(MP_QSTR_leave_critical_section), MP_ROM_PTR(&tildagon_leave_critical_section_obj)},
