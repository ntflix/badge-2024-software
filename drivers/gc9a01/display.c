...
static bool using_sasppu = false;
static bool use_sasppu_next = false;
...
static mp_obj_t enable_sasppu(mp_obj_t enable)
{
    mp_obj_t b = mp_obj_new_bool(mp_obj_get_int(enable));
    use_sasppu_next = b == mp_const_true;
    return b;
}
static MP_DEFINE_CONST_FUN_OBJ_1(enable_sasppu_obj, enable_sasppu);
...
static const mp_rom_map_elem_t display_module_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_enable_sasppu), MP_ROM_PTR(&enable_sasppu_obj)},
